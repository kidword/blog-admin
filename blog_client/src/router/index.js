...
export const asyncRoutes = [
  {
    ...
    redirect: '/blog/',
    name: 'Blog',
    meta: { title: '博客管理', icon: 'example', perms: ['blog/manage'] },
    children: [
      {
        path: 'data',
        name: 'data',
        component: () => import('@/views/blog/data'),
        meta: { title: '博客数据', icon: 'example', perms: ['blog/data'] }
      },
      {
        path: 'add',
        name: 'add',
        component: () => import('@/views/blog/add'),
        meta: { title: '博客列表', icon: 'example', perms: ['blog/list'] }
      }
    ]
  },
  {
